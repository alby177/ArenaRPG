# VISION
This file contains the description of how the game is going to appear. 

ArenaRPG is a small tactical RPG focused on character customization and strategic combat rather than exploration.
...
Characters use their equipment to defeat their opponents. It's the equipment that empower the character. Each player starts from the same power, the choose of the equipment enhance its strength. The player can defend itself using the obstacles around the map to block or slow down the enemy.
