...
- IT HAS -> Stamina regain. It can be doubled by standing still.

# Equipment
It groups all the entities which can be employed by the character. The available ones are Weapons and Armors. Characters can wear only one armor and use a weapon.
- IT HAS -> Durability.
...
- IT HAS -> Characters. It hosts them for the 1 vs 1 fight.
- IT HAS -> Obstacles. 
...
# Match
It is the main event of the game. It is the moment when the fight happens. It lasts until one of the characters end its life points. 
- IT HAS -> Arena.
...
- IT HAS -> Speed movement reduction (if it is spread on the ground)